...
import com.booking.response.ErrorResponse;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(NoAvilableSeatException.class)
	
	public ResponseEntity<?> noSeatAvilable(NoAvilableSeatException ex){
